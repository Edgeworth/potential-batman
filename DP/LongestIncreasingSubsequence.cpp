...
// liss   : a vector (which can be passed in as any size)
//          which will be set to contain the length of the
//          lis ending at each index
// parents: a vector (which can be passed in as any size)
//          which will be set to contain the index of the
//          penultumate element in the lis ending at each
//          index
