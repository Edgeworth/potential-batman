...
// calculates the "male optimal" stable marriage (i.e. there is no
// stable marriage where any man prefers his match over the one
// given here)
// a female optimal matching can be found by swapping men and women
...
void stable_marriage(const vvi& mpref, const vvi& fpref, vi& match) {
    match.resize(mpref.size(), -1); // initially no one matched
